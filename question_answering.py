...
# hasil_tokens, hasil_tagged = getPOSTagging(kandidat_jawaban)
# print(kandidat_jawaban)
# print(hasil_tokens)
# print(hasil_tagged)

# hasil_iob = getIOBNER(kandidat_jawaban)
# print(hasil_iob)
...
# # hasil_lemma = lemmatizer(kandidat_jawaban)
# # print(hasil_lemma)
# for i, s in enumerate(sentences):
#     doc = nlp(s)
#     tokens = [token.text for token in doc]
#     # print('Original Article: %s' % (s))
#     # print(doc.lemma_)
#     hasil_sentences_lemma = []
#     hasil_lemma = []
#     for token in doc:
#         # print(token.lemma_)
#         hasil_lemma.append(token.lemma_)
#         # if token.text != token.lemma_:
#         #     print('Original : %s, New: %s' % (token.text, token.lemma_))
#     # print(hasil_lemma[i])
#     print(hasil_lemma)
#     # hasil_sentences_lemma[i] = zip(hasil_lemma[i])
    
# print(hasil_sentences_lemma)
...
# sentences_hasil_stem = []
# for s in sentences:
#     hasil_stem = stemmer.stem(s)
#     sentences_hasil_stem.append(hasil_stem)
#     # print(hasil_stem)
# print(sentences_hasil_stem)
